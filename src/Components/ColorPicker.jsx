    ...
    ColorPicker = React.createClass({
        ...
        getInitialState() {
            return {
                ...
                saturation: (this.props.saturation !== undefined) ?
                    this.props.saturation : 100,
                lightness: (this.props.lightness !== undefined) ?
                    this.props.lightness : 50,
                alpha: (this.props.alpha !== undefined) ?
                    this.props.alpha : 1.0
            };
        },
        render() {
